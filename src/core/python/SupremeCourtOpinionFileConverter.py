...
class SupremeCourtOpinionFileConverter(DocumentConverter):
    '''
    Daniel Klein
    ...
    def __init__(self, file_to_parse, pickle_path):
        super(SupremeCourtOpinionFileConverter, self).__init__(file_to_parse, pickle_path)
        
    
    def convert_file(self):
        '''
        Returns a SupremeCourtOpinion object created from file.
        '''
        ...
        # tie the entire new SupremeCourtOpinion together and return it
        self.converted_doc = SupremeCourtOpinion(new_metadata, body_text, 
                                      self.output_path)
